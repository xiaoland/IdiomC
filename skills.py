...
class PuGongYing(Bot):
    ...
    def __init__(self, data):
        ...
        self.idiom_story = {
            ...
            '守株待兔': ['春秋时代有位宋国的农夫，他每天早上很早就到田里工作，一直到太阳下山才收拾农具准备回家。有一天，农夫正在田里辛苦的工作，突然却远远跑来一只兔子。这只兔子跑得又急又快，一个不小心，兔子撞上稻田旁边的大树，这一撞，撞断了兔子的颈部，兔子当场倒地死亡。一旁的农夫看到之后，急忙跑上前将死了的兔子一手抓起，然后很开心的收拾农具准备回家把这只兔子煮来吃。农夫心想，天底下既然有这么好的事，自己又何必每天辛苦的耕田从此以后，他整天守在大树旁，希望能再等到不小心撞死的兔子。可是许多天过去了，他都没等到撞死在大树下的兔子，反而因为他不处理农田的事，因此田里长满了杂草，一天比一天更荒芜。 ', ''],
            ...
            '兔死狐悲': ['“兔死狐悲”原作“狐死兔泣”。这个成语，原出自《宋史·李全传》。后又见于《元曲选·无名氏＜赚蒯通＞四》。],
...
　　         '玩火自焚': ['春秋初；卫国的公子州吁公然刺杀自己的哥哥卫桓公，自己当了国君。他当政后，一方面残酷地搜括百姓钱财，一方面拉拢宋、陈、蔡等诸侯国一起攻打郑国，借以树立自己的威望，转移国内百姓对他的反抗情绪。鲁隐公得知州吁弑兄篡位的事后，向大夫众仲道：“依你看，州吁这次夺权能够成功吗?他的国君位置能长久保住吗?”众仲摇摇头，说：“州吁依靠武力兴兵作乱，给百姓带来灾难，百姓决不会支持他。他如此残忍凶暴，没有亲近的人愿意跟随他。众人反对，亲信背离，要想取得成功是不可能的。”接着，众仲又换一个角度说：“兵，就像火一样。一味地用兵而不知加以收敛和节制，结果必然自己烧死自己。依我看,等待他的将是失败。”果然，不到一年，卫国人在陈国的帮助下，推翻了州吁的残酷统治，而且将他杀了。', ''],
            '玩物丧志': ['周武王姬发灭商后，建立了西周王朝。为了巩固自己的统治，周武王一面分封诸侯，一面派出使臣到边远地区，号召各国臣服周朝。
　　
